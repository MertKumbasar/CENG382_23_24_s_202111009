    ...
    public class EditReservationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            bool isConflict = _context.Reservations
                .Any(r => r.DateTime == Reservation.DateTime && r.RoomId == Reservation.RoomId &&
                          !r.IsDeleted);

            if (isConflict)
            {
                ModelState.AddModelError("Reservation.DateTime", "Conflict: There is already a reservation!!");
                return Page();
            }
